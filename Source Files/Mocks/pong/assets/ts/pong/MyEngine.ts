...
export class MyEngine extends Engine {
  ...
  constructor(game: Game, options?: PartialBy<MyIGameOptions, "canvasElementId">) {
    super(game, options);
    if ("hz" in (this as any)._options) {
      this.hz = (this as any)._options.hz;
      (this as any)._interval = 1000.0 / this.hz;
      console.log(`Setting interval to ${(this as any)._interval}, ${this.hz}Hz`);
    }
    if ("devicePixels" in (this as any)._options) {
      this.devicePixels = (this as any)._options.devicePixels;
      const ratio = window.devicePixelRatio;

      (this as any)._front.width = (this as any)._back.width = (this as any)._width * ratio;
      (this as any)._front.height = (this as any)._back.height = (this as any)._height * ratio;
