...
def create_annotation(selector, target, id_prefix, id_suffix, type="Boolean", value=True, motivation="tagging"):
    body = ResourceItem(id=id_prefix + id_suffix + "/body", type=type, value=value)
