...
Nun kann man darüber streiten, auf wessen Seite das Problem liegt, aber die Meldung kommt aus dem Kernel-Modul `mac80211`. Leider half es auch nicht wirklich das Energiemanagement fürs WLAN zu deaktivieren. Hintergrund ist das "[Transmit Power Control/Management (TPC)](https://de.wikipedia.org/wiki/Transmitter_Power_Control)", das für [IEEE 802.11h-2003](https://de.wikipedia.org/wiki/IEEE_802.11a#Sendeleistung) definiert ist. Demnach müssen WLAN-Geräte den Vorgaben eigentlich folgen, es gibt keine Untergrenze. Damit sieht der Standard streng genommen vor, dass er sein eigenes Funktionieren versagen darf.
