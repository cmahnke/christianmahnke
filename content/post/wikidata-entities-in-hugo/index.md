...
{{- else if hasPrefix $target "http" -}}
  ...
  {{- end -}}
{{- end -}}
{{- if or (hasPrefix $target "https://www.wikidata.org/wiki/Q") (hasPrefix $target "https://www.wikidata.org/entity/") -}}
...
Seit [Version 0.161.1](https://github.com/gohugoio/hugo/releases/tag/v0.161.1) kann Hugo auf den `Retry-After`-HTTP-Header reagieren.
