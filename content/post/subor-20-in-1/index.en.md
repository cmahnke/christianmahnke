...
[
  ...
  {"src": "img/back.jpg", "alt": "Rear view"}
]
{{</ gallery >}}
...
{{< gallery >}}
[
  {"src": "img/nasa-front.jpg", "alt": "Front view"},
  {"src": "img/nasa-back.jpg", "alt": "Rear view"}
]
{{</ gallery >}}

Technically speaking, this is an NES-to-Famicom adapter, designed to allow 60-pin games (Famicom) to be played on a 72-pin console (NES). These adapters were produced by various manufacturers. This one is from "Nasa", a name under which the [company "Lingli" sold its Famicom clones](https://hallyvorc.wixsite.com/unauthorizon/post/cut-into-the-number-of-famiclones-ever-produced-case-7-nasa); they were quite common in Spain, for example.
